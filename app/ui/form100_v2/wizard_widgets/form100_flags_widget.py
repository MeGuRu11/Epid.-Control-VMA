...
class Form100FlagsWidget(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.flag_emergency.toggled.connect(lambda _checked: self.changed.emit())
        self.flag_radiation.toggled.connect(lambda _checked: self.changed.emit())
        self.flag_sanitation.toggled.connect(lambda _checked: self.changed.emit())
