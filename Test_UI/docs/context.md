...
- Отложенные до финального этапа: UX-дефолты (Этап V) и Этап VI `Форма 100 МО РФ (v2.2)`.
...
- Этап VI `Форма 100 МО РФ (v2.2)` — не начат:
  - [ ] модели;
  - [ ] миграции;
  - [ ] UI;
  - [ ] PDF;
...
5. Итерация E (отложено на финал): `Форма 100` — модели/миграции/сервисы/UI/PDF/ZIP/аудит.
