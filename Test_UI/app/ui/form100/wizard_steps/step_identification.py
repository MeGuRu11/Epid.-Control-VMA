...
Левая половина: Form100StubWidget (корешок) в QScrollArea.
Правая половина: поля идентификации основного бланка.
"""
...
from ..form100_stub_widget import Form100StubWidget
...
class StepIdentification(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        # ── Правая часть: идентификация основного бланка ────────────────
